...
# for joining to list to get a list of all unique values
def Union(lst1, lst2):
...
def train():
    """This will Train the Naive Bayes Classifier on the descriptions that can be found in the 
   genre_data.csv file to classified descriptions into Genres
    accuracy scores, F1-Scores, and Confustion Matrix will be printed out after training"""
